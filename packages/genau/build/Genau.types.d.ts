 ...
 */
export type GenauEventType = 'modelDownloadProgress' | 'modelDownloadComplete' | 'modelDownloadError' | 'streamChunk' | 'streamComplete' | 'streamError';
/**
 ...
 */
export type GenauEvent = GenauDownloadProgressEvent | GenauStreamChunkEvent | GenauErrorEvent | {
    type: 'modelDownloadComplete';
    modelId: string;
} | {
    type: 'streamComplete';
};
//# sourceMappingURL=Genau.types.d.ts.map